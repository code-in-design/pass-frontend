    ...
    <Box backgroundColor="#f3f4fa" padding="132px 0">
      <Box w="560px" h="760px" borderRadius="24px" backgroundColor="#fff" margin="0 auto" padding="64px" display="flex" flexDirection="column">
        ...
        <Box position="relative">
          <Input variant="base" placeholder="이름을 입력해주세요" padding="18px 250px 18px 56px" height="56px" fontSize="16px" lineHeight="20px" fontWeight={700} letterSpacing={'-0.02em'} maxLength={10} />
        ...
        <Flex gap="12px" marginBottom="12px" position="relative">
          <Input variant="base" type="tel" placeholder='"-"를 제외하고 작성해주세요' width="306px" height="56px" padding="18px 72px 18px 56px" fontSize="16px" lineHeight="20px" fontWeight={700} letterSpacing={'-0.02em'} maxLength={11} />
